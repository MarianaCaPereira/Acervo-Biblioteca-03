...
public class TCC extends Geral{
    ...
    public TCC(int paginas, String tipo) {
        this.paginas = paginas;
        this.tipo = tipo;
    }

    public TCC(int paginas, String tipo, String autores, String titulo, int edicao, String cidade, String editora, int ano, String CDU, int quantidade, String assunto, String palavra1, String palavra2, float tamanho, int id, int emprestimo) {
    ...
    public boolean equals(Object obj) {
        return ((TCC) obj).hashCode() == hashCode();
    }
    ...
    public void cadastrarTCCDB() throws ClassNotFoundException, SQLException {
        ...
        String sql2 = "insert into TCC (id, tipo, paginas)";
        sql2 += "values (?, ?, ?)";
    ...
    public void excluirTCCDB() throws ClassNotFoundException, SQLException {
        
        //Tabela 2 
        Connection conn2 = MySqlConnection.getInstance().getConnection();
        String sql2 = "delete from TCC where id = ?";
    ...
    public static ArrayList<TCC> getTCCsDB() throws ClassNotFoundException, SQLException {

        ArrayList<TCC> listTCCs = new ArrayList<>();
        Connection conn;
            ...
            tcc.setTipo(tipo);
                ...
                while (rs.next()) { //Procurando a chave na tabela 1
                    ...
                    if(rs.getInt("id") == id){  //Verificando se as chaves são iguais
                        ...
                        tcc.setCidade(cidade);
                        tcc.setEditora(editora);
                        tcc.setAno(ano);
                        tcc.setAssunto(assunto);
                        tcc.setPalavra1(palavra1);
                        tcc.setPalavra2(palavra2);
